...
library(hextri)
library(plotrix)
# Creating a bar plot that visualizes the underrepresentation of voters by Party
...
# Creating a bar plot to visualize difference in seat share and vote share by party
...
# Dividing the dataset by region 
...
# Seat division under Sainte-Lague method for the South East
...
# ... for the North East
\ne_valid <- sum(north_east$`Valid votes`)
...
# Seat division under PR for UK Parliament
...
# Seat division under FPTP for UK Parliament
...
# Seat share vs vote share for PR
...
# Table for gain/loss from fptp to pr
...
# bar plot for gain/loss fptp to pr
